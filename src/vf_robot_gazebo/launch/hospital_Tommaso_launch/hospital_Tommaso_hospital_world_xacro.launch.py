...
#
# Hospital Tommaso (hospital) world (XACRO pipeline) — robot loaded from vf_robot_description xacro.
#
# Node graph:
...
#
# Run:  ros2 launch vf_robot_gazebo hospital_Tommaso_hospital_world_xacro.launch.py
