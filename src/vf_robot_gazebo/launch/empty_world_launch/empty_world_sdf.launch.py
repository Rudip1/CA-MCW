...
#
# Empty world (SDF pipeline) — robot loaded from model.sdf in vf_robot_gazebo/models/uvc1_virofighter
#
# Node graph:
...
#
# World file:    worlds/empty_world.world
# Env models:    models/(base only)
# Robot models:  models/uvc1_common, models/uvc1_virofighter (added via base models/ path)
#
# Run:  ros2 launch vf_robot_gazebo empty_world_sdf.launch.py
