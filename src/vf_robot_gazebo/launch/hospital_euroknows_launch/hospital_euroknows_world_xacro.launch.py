...
#
# Hospital euroknows world (XACRO pipeline) — robot loaded from vf_robot_description xacro.
#
# Node graph:
...
#
# Run:  ros2 launch vf_robot_gazebo hospital_euroknows_world_xacro.launch.py
