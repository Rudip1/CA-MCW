...
#
# Hospital my2 world (SDF pipeline) — robot loaded from model.sdf in vf_robot_gazebo/models/uvc1_virofighter
#
# Node graph:
...
#
# World file:    worlds/hospital_my2_world/hospital_my2.world
# Env models:    models/hospital_my2_models
# Robot models:  models/uvc1_common, models/uvc1_virofighter (added via base models/ path)
#
# Run:  ros2 launch vf_robot_gazebo hospital_my2_world_sdf.launch.py
...
def generate_launch_description():
    ...
    world = os.path.join(pkg_vf_gazebo, "worlds", "hospital_my2_world", "hospital_my2.world")
    ...
    gazebo_model_path = SetEnvironmentVariable(
        ...
        value=os.pathsep.join(
            [
                os.path.join(pkg_vf_gazebo, "models", "hospital_my2_models"),  # env-specific assets
