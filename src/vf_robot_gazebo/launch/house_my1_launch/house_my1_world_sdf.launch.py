...
#
# House my world (SDF pipeline) — robot loaded from model.sdf in vf_robot_gazebo/models/uvc1_virofighter
#
# Node graph:
...
#
# Run:  ros2 launch vf_robot_gazebo house_my1_world_sdf.launch.py
