...
#
# Hospital my1 world (XACRO pipeline) — robot loaded from vf_robot_description xacro.
#
# Node graph:
...
#   rviz2                     → visualisation
#
# World file:    worlds/hospital_my1_world/hospital_my1.world
# Env models:    models/hospital_my1_models
# Robot meshes:  resolved via package://vf_robot_description/meshes/...
#
# Run:  ros2 launch vf_robot_gazebo hospital_my1_world_xacro.launch.py
...
def generate_launch_description():
    ...
    world = os.path.join(pkg_vf_gazebo, "worlds", "hospital_my1_world", "hospital_my1.world")
    ...
    gazebo_model_path = SetEnvironmentVariable(
        ...
        value=os.pathsep.join(
            [
                os.path.join(pkg_vf_gazebo, "models", "hospital_my1_models"),  # env-specific assets
